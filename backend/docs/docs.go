...
const docTemplate = `{
        ...
        "/v1/admin/users/{name}/ban": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-internal_handler_UserBanStatusResp"
                        }
                    }
                }
            },
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "封禁状态、增加时长与原因；解除封禁时原因可为空",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.UpdateUserBanReq"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-internal_handler_CurrentUserBanStatusResp"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raids-lab_crater_internal_resputil.Response-internal_handler_VisibleUserBanStatusResp"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_raids-lab_crater_dao_model.UserBanAction": {
            "type": "string",
            "enum": [
                "ban",
                "extend",
        ...
        "github_com_raids-lab_crater_dao_model.UserBanRestrictions": {
            "type": "object",
            "properties": {
                "datasetDownload": {
                    "type": "boolean"
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-internal_handler_CurrentUserBanStatusResp": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
                ...
                "data": {
                    "$ref": "#/definitions/internal_handler.CurrentUserBanStatusResp"
                },
                "msg": {
                    "type": "string"
                }
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-internal_handler_UserBanStatusResp": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
                ...
                "data": {
                    "$ref": "#/definitions/internal_handler.UserBanStatusResp"
                },
                "msg": {
                    "type": "string"
                }
        ...
        "github_com_raids-lab_crater_internal_resputil.Response-internal_handler_VisibleUserBanStatusResp": {
            "type": "object",
            "properties": {
                "code": {
                    "description": "依然保持 int (ErrorCode) 类型",
                ...
                "data": {
                    "$ref": "#/definitions/internal_handler.VisibleUserBanStatusResp"
                },
                "msg": {
                    "type": "string"
                }
        ...
        "internal_handler.CurrentUserBanStatusResp": {
            "type": "object",
            "properties": {
                "banRestrictions": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanRestrictions"
                },
                "banned": {
                    "type": "boolean"
                },
        ...
        "internal_handler.UpdateUserBanReq": {
            "type": "object",
            "required": [
                "banned"
            ],
        ...
        "internal_handler.UserBanRecordResp": {
            "type": "object",
            "properties": {
                "action": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanAction"
                },
                "banRestrictions": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanRestrictions"
                },
        ...
        "internal_handler.UserBanStatusResp": {
            "type": "object",
            "properties": {
                "banRestrictions": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanRestrictions"
                ...
                "records": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.UserBanRecordResp"
                    }
                }
            }
        },
        ...
        "internal_handler.VisibleUserBanRecordResp": {
            "type": "object",
            "properties": {
                "action": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanAction"
        ...
        "internal_handler.VisibleUserBanStatusResp": {
            "type": "object",
            "properties": {
                "banRestrictions": {
                    "$ref": "#/definitions/github_com_raids-lab_crater_dao_model.UserBanRestrictions"
                ...
                "records": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_handler.VisibleUserBanRecordResp"
                    }
                }
            }
        },
